...
# with command line options: UserCode/GEMPhysics/python/ZprimeTo2mu_M6000GeV_14TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --conditions auto:upgrade2019 --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2019WithGem --magField 38T_PostLS1 --datatier GEN-SIM-RECO --geometry Extended2019 --eventcontent AODSIM -n 10 --no_exec --fileout ZprimeTo2mu_M3600GeV_14TeV_620slhc5.root
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('UserCode/GEMPhysics/python/ZprimeTo2mu_M6000GeV_14TeV_cff.py nevts:10'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ZprimeTo2mu_M6000GeV_14TeV_620slhc5.root'),
