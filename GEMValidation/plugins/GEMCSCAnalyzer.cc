  ...
  for(auto d: match_gd.superChamberIdsDigi())
  {
    ...
    if (odd)
    {
      ...
      if (is_valid(lct_odd[st]))
      {
        ...
        etrk_[st].dphi_pad_odd = deltaPhi((float)etrk_[st].phi_lct_odd, (float)etrk_[st].phi_pad_odd);
    ...
    else
    {
      ...
      if (is_valid(lct_even[st]))
      {
        ...
        etrk_[st].dphi_pad_even = deltaPhi((float)etrk_[st].phi_lct_even, (float)etrk_[st].phi_pad_even);
...
//       etrk_[st].chamber_odd |= 3;
      ...
      if (is_valid(lct_odd[st]))
      {
        ...
        etrk_[st].dphi_rpcstrip_odd = deltaPhi((float)etrk_[st].phi_lct_odd, (float)etrk_[st].phi_rpcstrip_odd);
...
//       etrk_[st].chamber_even |= 3;
      ...
      if (is_valid(lct_even[st]))
      {
        ...
        etrk_[st].dphi_rpcstrip_even = deltaPhi((float)etrk_[st].phi_lct_even, (float)etrk_[st].phi_rpcstrip_even);
...
void GEMCSCAnalyzer::analyzeTrackChamberDeltas(SimTrackMatchManager& match, int trk_no)
{
  ...
  if (verbose_ > 1) // ---- GEMDigiMatcher debug printouts
  {
    ...
    cout<<"n_gd_ids_pad "<<match_gd.detIdsPad().size()<<endl;
